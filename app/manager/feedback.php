...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_status'])) {
    ...
    if (in_array($status, $allowed)) {
        ...
        logActivity($pdo, $_SESSION['user_id'], 'REVIEW_FEEDBACK', "Staff reviewed feedback #$fid, status: $status");
...
$sql .= ' ORDER BY FIELD(f.priority,"Urgent","High","Medium","Low"), f.submitted_at DESC';
...
?>
<div class="topbar">
  <span class="topbar-title">All Feedback</span>
</div>

<div class="content">
  <div class="page-header">
    <h1>Feedback</h1>
    <p>Review, update status, and add notes to submitted feedback.</p>
  </div>
